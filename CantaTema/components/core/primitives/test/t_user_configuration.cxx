...
TEST(UserConfigurationTest, DefaultValuesInitialization) {
    ...
    EXPECT_EQ(config.reference_extraction.max_pdf_page_count, 100u);
    ...
    EXPECT_FLOAT_EQ(config.reference_extraction.importance_weight_bg_color, 1.4f);
    EXPECT_EQ(config.reference_extraction.min_chunk_word_count, 4u);
